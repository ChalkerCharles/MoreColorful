...
public class ModDataMapProvider extends DataMapProvider {
    ...
    protected void gather() {
        builder(NeoForgeDataMaps.FURNACE_FUELS)
                ...
                .add(ModItems.OAK_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.SPRUCE_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.BIRCH_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.JUNGLE_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.ACACIA_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.DARK_OAK_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.MANGROVE_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.CHERRY_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.BAMBOO_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.CRABAPPLE_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.EBONY_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.GINKGO_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.MAPLE_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.FROST_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.DAWN_REDWOOD_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.JACARANDA_MAILBOX, new FurnaceFuel(300), false)
                .add(ModItems.WILLOW_MAILBOX, new FurnaceFuel(300), false);
