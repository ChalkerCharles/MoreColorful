...
public class ModBlocks {
    ...
    public static final DeferredBlock<LeavesBlock> CRABAPPLE_LEAVES = BLOCKS.register("crabapple_leaves", ()-> new PetalLeavesBlock(ofFullCopy(Blocks.CHERRY_LEAVES).mapColor(MapColor.CRIMSON_NYLIUM), ModParticles.CRABAPPLE_LEAVES));
    public static final DeferredBlock<SaplingBlock> CRABAPPLE_SAPLING = BLOCKS.register("crabapple_sapling", ()-> new SaplingBlock(ModTreeGrower.CRABAPPLE, ofFullCopy(Blocks.CHERRY_SAPLING).mapColor(MapColor.CRIMSON_NYLIUM)));
    ...
    public static final DeferredBlock<PinkPetalsBlock> BEGONIAS = BLOCKS.register("begonias", ()-> new PinkPetalsBlock(ofFullCopy(Blocks.PINK_PETALS).mapColor(MapColor.CRIMSON_NYLIUM)));
    ...
    public static final DeferredBlock<LeavesBlock> ORANGE_BIRCH_LEAVES = BLOCKS.register("orange_birch_leaves", ()-> new FallingLeavesBlock(ofFullCopy(Blocks.BIRCH_LEAVES).mapColor(MapColor.TERRACOTTA_ORANGE), ModParticles.ORANGE_BIRCH_LEAVES));
    public static final DeferredBlock<SaplingBlock> ORANGE_BIRCH_SAPLING = BLOCKS.register("orange_birch_sapling", ()-> new SaplingBlock(ModTreeGrower.ORANGE_BIRCH, ofFullCopy(Blocks.BIRCH_SAPLING).mapColor(MapColor.TERRACOTTA_ORANGE)));
    ...
    public static final DeferredBlock<LeafLitterBlock> ORANGE_BIRCH_LEAF_LITTER = BLOCKS.register("orange_birch_leaf_litter", ()-> new LeafLitterBlock(ofFullCopy(Blocks.PINK_PETALS).mapColor(MapColor.TERRACOTTA_ORANGE).sound(ModSoundTypes.LEAF_LITTER).replaceable()));
    ...
    public static final DeferredBlock<RotatedPillarBlock> STRIPPED_FROST_LOG = BLOCKS.register("stripped_frost_log", ()-> new RotatedPillarBlock(ofFullCopy(Blocks.STRIPPED_CHERRY_LOG).mapColor(MapColor.SNOW)));
    public static final DeferredBlock<RotatedPillarBlock> STRIPPED_FROST_WOOD = BLOCKS.register("stripped_frost_wood", ()-> new RotatedPillarBlock(ofFullCopy(Blocks.STRIPPED_CHERRY_WOOD).mapColor(MapColor.SNOW)));
    public static final DeferredBlock<Block> FROST_PLANKS = BLOCKS.register("frost_planks", ()-> new Block(ofFullCopy(Blocks.CHERRY_PLANKS).mapColor(MapColor.SNOW)));
    public static final DeferredBlock<StairBlock> FROST_STAIRS = BLOCKS.register("frost_stairs", ()-> stair(FROST_PLANKS.get()));
    public static final DeferredBlock<SlabBlock> FROST_SLAB = BLOCKS.register("frost_slab", ()-> new SlabBlock(ofFullCopy(Blocks.CHERRY_SLAB).mapColor(MapColor.SNOW)));
    public static final DeferredBlock<FenceBlock> FROST_FENCE = BLOCKS.register("frost_fence", ()-> new FenceBlock(ofFullCopy(Blocks.CHERRY_FENCE).mapColor(MapColor.SNOW)));
    public static final DeferredBlock<FenceGateBlock> FROST_FENCE_GATE = BLOCKS.register("frost_fence_gate", ()-> new FenceGateBlock(ModWoodTypes.FROST, ofFullCopy(Blocks.CHERRY_FENCE).mapColor(MapColor.SNOW)));
    public static final DeferredBlock<DoorBlock> FROST_DOOR = BLOCKS.register("frost_door", ()-> new DoorBlock(ModBlockSetTypes.FROST, ofFullCopy(Blocks.CHERRY_DOOR).mapColor(MapColor.SNOW)));
    public static final DeferredBlock<TrapDoorBlock> FROST_TRAPDOOR = BLOCKS.register("frost_trapdoor", ()-> new TrapDoorBlock(ModBlockSetTypes.FROST, ofFullCopy(Blocks.CHERRY_TRAPDOOR).mapColor(MapColor.SNOW)));
    public static final DeferredBlock<PressurePlateBlock> FROST_PRESSURE_PLATE = BLOCKS.register("frost_pressure_plate", ()-> new PressurePlateBlock(ModBlockSetTypes.FROST, ofFullCopy(Blocks.CHERRY_PRESSURE_PLATE).mapColor(MapColor.SNOW)));
    ...
    public static final DeferredBlock<StandingSignBlock> FROST_SIGN = BLOCKS.register("frost_sign", ()-> new StandingSignBlock(ModWoodTypes.FROST, ofFullCopy(Blocks.CHERRY_SIGN).mapColor(MapColor.SNOW)));
    public static final DeferredBlock<WallSignBlock> FROST_WALL_SIGN = BLOCKS.register("frost_wall_sign", ()-> new WallSignBlock(ModWoodTypes.FROST, ofFullCopy(Blocks.CHERRY_WALL_SIGN).mapColor(MapColor.SNOW).lootFrom(FROST_SIGN)));
    public static final DeferredBlock<CeilingHangingSignBlock> FROST_HANGING_SIGN = BLOCKS.register("frost_hanging_sign", ()-> new CeilingHangingSignBlock(ModWoodTypes.FROST, ofFullCopy(Blocks.CHERRY_HANGING_SIGN).mapColor(MapColor.SNOW)));
    public static final DeferredBlock<WallHangingSignBlock> FROST_WALL_HANGING_SIGN = BLOCKS.register("frost_wall_hanging_sign", ()-> new WallHangingSignBlock(ModWoodTypes.FROST, ofFullCopy(Blocks.CHERRY_WALL_HANGING_SIGN).mapColor(MapColor.SNOW).lootFrom(FROST_HANGING_SIGN)));
    public static final DeferredBlock<LeavesBlock> FROST_LEAVES = BLOCKS.register("frost_leaves", ()-> new PetalLeavesBlock(ofFullCopy(Blocks.CHERRY_LEAVES).mapColor(MapColor.ICE), ModParticles.FROST_LEAVES));
    public static final DeferredBlock<SaplingBlock> FROST_SAPLING = BLOCKS.register("frost_sapling", ()-> new SaplingBlock(ModTreeGrower.FROST, ofFullCopy(Blocks.CHERRY_SAPLING).mapColor(MapColor.ICE)));
    ...
    public static final DeferredBlock<PinkPetalsBlock> FROSTY_PETALS = BLOCKS.register("frosty_petals", ()-> new PinkPetalsBlock(ofFullCopy(Blocks.PINK_PETALS).mapColor(MapColor.ICE)));
    ...
    public static final DeferredBlock<RotatedPillarBlock> JACARANDA_LOG = BLOCKS.register("jacaranda_log", ()-> log(Blocks.CHERRY_LOG, MapColor.WOOL, MapColor.TERRACOTTA_LIGHT_GRAY));
    ...
    public static final DeferredBlock<RotatedPillarBlock> STRIPPED_JACARANDA_LOG = BLOCKS.register("stripped_jacaranda_log", ()-> new RotatedPillarBlock(ofFullCopy(Blocks.STRIPPED_CHERRY_LOG).mapColor(MapColor.WOOL)));
    public static final DeferredBlock<RotatedPillarBlock> STRIPPED_JACARANDA_WOOD = BLOCKS.register("stripped_jacaranda_wood", ()-> new RotatedPillarBlock(ofFullCopy(Blocks.STRIPPED_CHERRY_WOOD).mapColor(MapColor.WOOL)));
    public static final DeferredBlock<Block> JACARANDA_PLANKS = BLOCKS.register("jacaranda_planks", ()-> new Block(ofFullCopy(Blocks.CHERRY_PLANKS).mapColor(MapColor.WOOL)));
    ...
    public static final DeferredBlock<SlabBlock> JACARANDA_SLAB = BLOCKS.register("jacaranda_slab", ()-> new SlabBlock(ofFullCopy(Blocks.CHERRY_SLAB).mapColor(MapColor.WOOL)));
    public static final DeferredBlock<FenceBlock> JACARANDA_FENCE = BLOCKS.register("jacaranda_fence", ()-> new FenceBlock(ofFullCopy(Blocks.CHERRY_FENCE).mapColor(MapColor.WOOL)));
    public static final DeferredBlock<FenceGateBlock> JACARANDA_FENCE_GATE = BLOCKS.register("jacaranda_fence_gate", ()-> new FenceGateBlock(ModWoodTypes.JACARANDA, ofFullCopy(Blocks.CHERRY_FENCE).mapColor(MapColor.WOOL)));
    public static final DeferredBlock<DoorBlock> JACARANDA_DOOR = BLOCKS.register("jacaranda_door", ()-> new DoorBlock(ModBlockSetTypes.JACARANDA, ofFullCopy(Blocks.CHERRY_DOOR).mapColor(MapColor.WOOL)));
    public static final DeferredBlock<TrapDoorBlock> JACARANDA_TRAPDOOR = BLOCKS.register("jacaranda_trapdoor", ()-> new TrapDoorBlock(ModBlockSetTypes.JACARANDA, ofFullCopy(Blocks.CHERRY_TRAPDOOR).mapColor(MapColor.WOOL)));
    public static final DeferredBlock<PressurePlateBlock> JACARANDA_PRESSURE_PLATE = BLOCKS.register("jacaranda_pressure_plate", ()-> new PressurePlateBlock(ModBlockSetTypes.JACARANDA, ofFullCopy(Blocks.CHERRY_PRESSURE_PLATE).mapColor(MapColor.WOOL)));
    public static final DeferredBlock<ButtonBlock> JACARANDA_BUTTON = BLOCKS.register("jacaranda_button", ()-> woodenButton(ModBlockSetTypes.JACARANDA, Blocks.CHERRY_BUTTON, MapColor.WOOL));
    public static final DeferredBlock<StandingSignBlock> JACARANDA_SIGN = BLOCKS.register("jacaranda_sign", ()-> new StandingSignBlock(ModWoodTypes.JACARANDA, ofFullCopy(Blocks.CHERRY_SIGN).mapColor(MapColor.WOOL)));
    public static final DeferredBlock<WallSignBlock> JACARANDA_WALL_SIGN = BLOCKS.register("jacaranda_wall_sign", ()-> new WallSignBlock(ModWoodTypes.JACARANDA, ofFullCopy(Blocks.CHERRY_WALL_SIGN).mapColor(MapColor.WOOL).lootFrom(JACARANDA_SIGN)));
    public static final DeferredBlock<CeilingHangingSignBlock> JACARANDA_HANGING_SIGN = BLOCKS.register("jacaranda_hanging_sign", ()-> new CeilingHangingSignBlock(ModWoodTypes.JACARANDA, ofFullCopy(Blocks.CHERRY_HANGING_SIGN).mapColor(MapColor.WOOL)));
    public static final DeferredBlock<WallHangingSignBlock> JACARANDA_WALL_HANGING_SIGN = BLOCKS.register("jacaranda_wall_hanging_sign", ()-> new WallHangingSignBlock(ModWoodTypes.JACARANDA, ofFullCopy(Blocks.CHERRY_WALL_HANGING_SIGN).mapColor(MapColor.WOOL).lootFrom(JACARANDA_HANGING_SIGN)));
    public static final DeferredBlock<LeavesBlock> JACARANDA_LEAVES = BLOCKS.register("jacaranda_leaves", ()-> new PetalLeavesBlock(ofFullCopy(Blocks.CHERRY_LEAVES).mapColor(MapColor.COLOR_PURPLE), ModParticles.JACARANDA_LEAVES));
    public static final DeferredBlock<SaplingBlock> JACARANDA_SAPLING = BLOCKS.register("jacaranda_sapling", ()-> new SaplingBlock(ModTreeGrower.JACARANDA, ofFullCopy(Blocks.CHERRY_SAPLING).mapColor(MapColor.COLOR_PURPLE)));
    ...
    public static final DeferredBlock<PinkPetalsBlock> VIOLETS = BLOCKS.register("violets", ()-> new TallFlowerbedBlock(ofFullCopy(Blocks.PINK_PETALS).mapColor(MapColor.COLOR_PURPLE)));
    ...
    public static final DeferredBlock<Block> REED = BLOCKS.register("reed", ()-> new ReedBlock(tallFlowerProperties().mapColor(MapColor.PLANT)));
