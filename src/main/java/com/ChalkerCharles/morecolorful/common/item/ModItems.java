...
public class ModItems {
    ...
    public static final Supplier<Item> TOMTOM_DRUM = ITEMS.register("tom-tom_drum", ()-> new BlockItem(ModBlocks.TOMTOM_DRUM.get(), new Item.Properties()));
    ...
    public static final Supplier<Item> XYLOPHONE = ITEMS.register("xylophone", ()-> new BlockItem(ModBlocks.XYLOPHONE.get(), new Item.Properties()));
    ...
    public static final Supplier<Item> FIDDLE_BOW = ITEMS.register("fiddle_bow", ()-> new Item(new Item.Properties().stacksTo(1)));
    public static final Supplier<Item> DRUMSTICK = ITEMS.register("drumstick", ()-> new DrumstickItem(new Item.Properties()));
    public static final Supplier<Item> BASS = ITEMS.register("bass", ()-> new GuitarItem(InstrumentsType.BASS, new Item.Properties().stacksTo(1)));
    public static final Supplier<Item> GUITAR = ITEMS.register("guitar", ()-> new GuitarItem(InstrumentsType.GUITAR, new Item.Properties().stacksTo(1)));
    public static final Supplier<Item> FLUTE = ITEMS.register("flute", ()-> new BothHandsInstrumentItem(InstrumentsType.FLUTE, new  Item.Properties().stacksTo(1)));
    ...
    public static final Supplier<Item> DIDGERIDOO = ITEMS.register("didgeridoo", ()-> new DidgeridooItem(InstrumentsType.DIDGERIDOO, new Item.Properties()));
    public static final Supplier<Item> BANJO = ITEMS.register("banjo", ()-> new GuitarItem(InstrumentsType.BANJO, new Item.Properties().stacksTo(1)));
