...
public class ModItems {
    ...
    // Items
    public static final Supplier<Item> VIOLIN = ITEMS.register("violin", ()-> new ViolinItem(InstrumentsType.VIOLIN, new Item.Properties().stacksTo(1)));
    ...
    public static final Supplier<Item> FLUTE = ITEMS.register("flute", ()-> new FluteItem(InstrumentsType.FLUTE, new  Item.Properties().stacksTo(1)));
