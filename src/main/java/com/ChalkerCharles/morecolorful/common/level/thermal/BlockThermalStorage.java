...
public class BlockThermalStorage {
    ...
    private volatile BlockDataLayerStorageMap visibleSectionData;
    private final BlockDataLayerStorageMap updatingSectionData;
    ...
    protected BlockThermalStorage(ChunkSource chunkSource) {
        ...
        this.updatingSectionData = new BlockDataLayerStorageMap(new Long2ObjectOpenHashMap<>());
    ...
    @Nullable
    private DataLayer getDataLayer(BlockDataLayerStorageMap pMap, long pSectionPos) {
    ...
    protected void swapSectionMap() {
        if (!this.changedSections.isEmpty()) {
            BlockDataLayerStorageMap map = this.updatingSectionData.copy();
            map.disableCache();
        ...
        if (!this.sectionsAffectedByThermalUpdates.isEmpty()) {
            ...
            while (longiterator.hasNext()) {
                ...
                IChunkSourceExtension.onThermalUpdate(this.chunkSource, SectionPos.of(i));
            }
    ...
    private static final class BlockDataLayerStorageMap extends DataLayerStorageMap<BlockDataLayerStorageMap> {
        private BlockDataLayerStorageMap(Long2ObjectOpenHashMap<DataLayer> pMap) {
            super(pMap);
        }
