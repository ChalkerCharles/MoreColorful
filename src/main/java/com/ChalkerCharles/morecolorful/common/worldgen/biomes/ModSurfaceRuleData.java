...
public class ModSurfaceRuleData {
    ...
    public static SurfaceRules.RuleSource overworld() {
                        ...
                        SurfaceRules.sequence(
                                SurfaceRules.ifTrue(
                                        ...
                                        SurfaceRules.ifTrue(
                                                isAbove62,
                                                SurfaceRules.ifTrue(
                                                        SurfaceRules.not(isAbove63), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.SWAMP, 0.0), WATER)
                                                )
                                        )
                                )
                        )
        ...
        SurfaceRules.RuleSource ruleSource = SurfaceRules.ifTrue(SurfaceRules.abovePreliminarySurface(), surfaceRules);
