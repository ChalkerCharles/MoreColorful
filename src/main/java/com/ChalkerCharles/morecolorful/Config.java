...
// An example config class. This is not required, but it's a.json good idea to have one to keep your config organized.
...
public class Config
{
    ...
    static void onLoad(final ModConfigEvent event)
    {
        ...
        // convert the list of strings into a.json set of items
